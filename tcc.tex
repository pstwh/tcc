...
Portando o objetivo desse trabalho é a comparação de diversas arquiteturas de redes recorrentes, aplicadas à resolução do problema de identificação de comentários tóxicos.
