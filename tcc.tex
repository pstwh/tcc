...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.3\textwidth]{images/gru_gate.png}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.3\textwidth]{images/lstm_gate.png}
